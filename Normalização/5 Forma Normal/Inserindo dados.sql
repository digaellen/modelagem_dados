...
INSERT INTO TELEFONE_CLIENTES (COD_TELEFONE, COD_CLIENTE, TELEFONE) VALUES
...
('CT008',   'CLT004',   '(31)9999-7777' ),
('CLT009',  'CLT005',   '(47)2222-3333' ),
('CLT010',  'CLT006',   '(61)3333-2222' ),
('CLT011',  'CLT007',   '(71)9999-1111' ),
('CLT012',  'CLT007',   '(71)8888-2222' ),
('CLT013',  'CLT008',   '(81)7777-4444' ),
('CLT014',  'CLT009',   '(85)4444-6666' ),
('CLT015',  'CLT009',   '(85)5555-7777' ),
('CLT016',  'CLT010',   '(61) 3333-2222'),
('CLT017',  'CLT011',   '(71)9998-1251' ),
('CLT018',  'CLT011',   '(71)8878-2472' ),
('CLT019',  'CLT012',   '(21)8765-4321' ),
('CLT020',  'CLT013',   '(81)7777-1578' ),
('CLT021',  'CLT014',   '(31)6555-8788' ),
('CLT022',  'CLT014',   '(31)1999-2377' ),
('CLT023',  'CLT015',   '(47)2452-2933' ),
('CLT024',  'CLT016',   '(85)4412-6176' ),
('CLT025',  'CLT016',   '(85)7555-1777' ),
('CLT026',  'CLT017',   '(98)6675-3433' ),
('CLT027',  'CLT017',   '(98)7713-1478' ),
('CLT028',  'CLT018',   '(84)1111-5555' ),
('CLT029',  'CLT019',   '(98)6666-3333' ),
('CLT030',  'CLT019',   '(98)7777-5555' ),
('CLT031',  'CLT020',   '(84)1111-5555' );
...
('LVR010',  29.90,  2013, 'Aventura',             'As Crônicas de Nárnia',                    9788578271571, 'AUT010', 'ED1009', 60),
...
('PED001', 'CLT001', 'LOJ001', '2023-07-01', 180.98   ),
('PED002', 'CLT002', 'LOJ001', '2023-07-02', 71.00    ),
('PED003', 'CLT003', 'LOJ001', '2023-07-03', 110.59   ),  
('PED004', 'CLT004', 'LOJ001', '2023-07-04', 50.40    ),
('PED005', 'CLT005', 'LOJ001', '2023-07-05', 177.35   ),
('PED006', 'CLT006', 'LOJ001', '2023-07-06', 48.00    ),
('PED007', 'CLT007', 'LOJ001', '2023-07-07', 84.39    ),
('PED008', 'CLT008', 'LOJ001', '2023-07-08', 73.48    ),
('PED009', 'CLT009', 'LOJ002', '2023-07-09', 29.99    ),
('PED010', 'CLT010', 'LOJ002', '2023-07-10', 91.70    ),
('PED011', 'CLT005', 'LOJ002', '2023-07-11', 89.79    ),
('PED012', 'CLT012', 'LOJ002', '2023-07-12', 18.99    ),
('PED013', 'CLT013', 'LOJ002', '2023-07-13', 102.40   ),
('PED014', 'CLT014', 'LOJ002', '2023-07-14', 65.80    ),
('PED015', 'CLT015', 'LOJ002', '2023-07-15', 115.75   ),
('PED016', 'CLT016', 'LOJ002', '2023-07-16', 59.98    ),
('PED017', 'CLT017', 'LOJ001', '2023-07-17', 118.59   ),
('PED018', 'CLT018', 'LOJ001', '2023-07-18', 69.10    ),
('PED020', 'CLT020', 'LOJ001', '2023-07-20', 56.70    );
...
('DEP005', 'CLB004',  'Mario Antonio'   ),
('DEP007', 'CLB006',  'Maria Joana'     );

INSERT INTO COLABORADORES_CARGO (COD_CARG, COD_COLAB) VALUES
('CAR001','CLB001'  ),
('CAR002','CLB002'  ),
('CAR003','CLB003'  ),
('CAR004','CLB004'  ),
...
INSERT INTO SALARIO_CARGO (COD_CARG, DEPARTAMENTO, CARGO, SALARIO_BASE) VALUES
('CAR001',  'Vendas',       'Vendedor',             3500.00),
('CAR002',  'Vendas',       'Gerente de Vendas',    5000.00),
('CAR003',  'Marketing',    'Analista de Mkt',      4200.00),
('CAR004',  'RH',           'Analista de RH',       3800.00),
('CAR005',  'RH',           'Gerente de RH',        5500.00);

INSERT INTO LOJAS (COD_LOJA, LOJA) VALUES
('LOJ001',  'CENTRO'),
('LOJ002',  'SHOPPING');

INSERT INTO FORNECEDOR (COD_FORN, FORNECEDOR) VALUES
('FOR001',  'CORREIO'),
('FOR002',  'BRASPRES');

/*INSERT INTO ENTREGAS (COD_FORN, COD_LOJA, COD_EDITORA) VALUES
('FOR001',  'LOJ001',   'ED1001'),
('FOR001',  'LOJ002',   'ED1001'),
('FOR002',  'LOJ002',   'ED1003'),
('FOR002',  'LOJ002',   'ED1005'),
('FOR002',  'LOJ002',   'ED1010'),*/
